...
growth_hacking = Product.create(title: "Growth Hacking", 
 ...
 price: "800", sku: "GROHACK1", download_url: "https://s3-ap-northeast-1.amazonaws.com/one-month-stripe-payments-jb/Capture-d%E2%80%99e%CC%81cran-2016-09-11-a%CC%80-14.47.50.png",details: "You'll get one video", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", 
 subtitle: "Ongoing Course", author: "Mattan Griffel", length: "6 months", author_image_name: "teacher-image.jpg", 
 price: "800", sku: "GROHACK2", download_url: "https://s3-ap-northeast-1.amazonaws.com/one-month-stripe-payments-jb/Capture-d%E2%80%99e%CC%81cran-2016-09-11-a%CC%80-14.47.50.png",details: "We'll charge you monthly for unlimited access to our mentoring team", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
